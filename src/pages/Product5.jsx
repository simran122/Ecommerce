...
import product2 from '../assets/img/product5.png';
                    ...
                    <div className='product-container-content-info'>
                        ...
                        <div className='product-container-content-info-buttons'>
                            <div className='product-container-content-info-buttons-buying'>
                                ...
                                <div onClick={() => window.open('https://buy.stripe.com/test_aEUaIAafieYSaIg9AG', '_blank')} className='product-container-content-info-buttons-buying-buy'>
                                    Buy Now
                                </div>
                            </div>
