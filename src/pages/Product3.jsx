...
import product2 from '../assets/img/product3.png';
                    ...
                    <div className='product-container-content-info'>
                        ...
                        <div className='product-container-content-info-buttons'>
                            <div className='product-container-content-info-buttons-buying'>
                                ...
                                <div onClick={() => window.open('https://buy.stripe.com/test_dR6dUMgDG5oi2bK7sw', "_blank")} className='product-container-content-info-buttons-buying-buy'>
                                    Buy Now
                                </div>
                            </div>
